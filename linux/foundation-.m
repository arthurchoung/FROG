/*
 ...
 Copyright (c) 2025 Arthur Choung. All rights reserved.
...
static FILE *FROG_stdout = NULL;

#define OUT(...) ((void)fprintf(FROG_stdout, __VA_ARGS__))

static FILE *FROG_stderr = NULL;

#define ERR(...) ((void)fprintf(FROG_stderr, __VA_ARGS__))
#define LOG(...) ((void)fprintf(FROG_stderr, __VA_ARGS__))
...
void NSOut(id formatString, ...)///$;
{
    ...
    vfprintf(FROG_stdout, [formatString UTF8String], args);
    va_end(args);
#else
...
void NSErr(id formatString, ...)///$;
{
    ...
    va_list args;
    va_start(args, formatString);
    vfprintf(FROG_stderr, [formatString UTF8String], args);
    va_end(args);
#else
    char *fmt = [formatString UTF8String];
    char *strp = NULL;
...
void FROG_initialize_stdout(FILE *fp)
{
    FROG_stdout = fp;
}

void FROG_initialize(FILE *fp)
{
    FROG_stderr = fp;
...
fprintf(FROG_stderr, "ERROR! register_printf_function\n");
        exit(0);
    }
#endif
