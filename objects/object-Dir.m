...
+ (id)Dir
{
    ...
    [obj setValue:@"frogDir:'Config/dirMenu.csv'|parseCSVFile|asMenu" forKey:@"navigationRightMouseDownMessage"];
...
- (void)handleRightMouseDown:(id)event
{
    if (_buttonHover) {
        ...
        id obj = [[[Definitions frogDir:@"Config/fileMenu.csv"] parseCSVFile] asMenu];
        if (obj) {
