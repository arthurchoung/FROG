...
"Test showAlert",,"NSArray|addObject:'frog'|addObject:'alert'|addObject:(NSArray|addObject:'xclip'|addObject:'-o'|runCommandAndReturnOutput|asString)|runCommandInBackground"
,,
EOF
